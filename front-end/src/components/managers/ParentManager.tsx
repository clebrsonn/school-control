...
const ParentManager: React.FC = () => {
    ...
    const {
        ...
        fields: [
            ...
            { name: 'phone', value: '', isRequired: true }
        ]
    });
    ...
    const handleAddParent = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const createdParent = await createParent(newParent as IResponsible);
    ...
    const resetForm = () => {
        ['name', 'phone'].forEach((fieldName) =>
            setFieldValue(fieldName as keyof Partial<IResponsible>, '')
        );
    };
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            setParents((prevParents) =>
                prevParents.filter((parent) => parent._id !== id)
            );
                ...
                <Form>
                    <Form.Group controlId="formParentName">
                        ...
                        <Form.Control
                            ...
                            onBlur={(e) =>
                                validateField('name', e.target.value, true)
                            }
